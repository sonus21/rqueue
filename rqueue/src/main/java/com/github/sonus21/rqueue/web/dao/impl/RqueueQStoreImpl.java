...
@Repository
public class RqueueQStoreImpl implements RqueueQStore {
  private final RqueueRedisTemplate<QueueConfig> rqueueRedisTemplate;

  @Autowired
  public RqueueQStoreImpl(RqueueConfig rqueueConfig) {
    this(new RqueueRedisTemplate<>(rqueueConfig.getConnectionFactory()));
  }

  public RqueueQStoreImpl(RqueueRedisTemplate<QueueConfig> rqueueRedisTemplate) {
