...
@NoArgsConstructor
public class EmailTask extends BaseQueueMessage {
  private String email;
  private String subject;
  private String body;

  public EmailTask(String id, String email, String subject, String body) {
    super(id);
    this.email = email;
  ...
  public static EmailTask newInstance() {
    ...
    return new EmailTask(id, email, subject, body);
  }
}
