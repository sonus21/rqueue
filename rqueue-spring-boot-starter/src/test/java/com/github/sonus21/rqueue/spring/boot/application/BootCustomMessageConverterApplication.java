...
public class BootCustomMessageConverterApplication extends CustomMessageConverterApplication {
  public static void main(String[] args) {
    ...
    SpringApplication.run(BootCustomMessageConverterApplication.class, args);
  }
}
