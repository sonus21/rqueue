...
public class RedisAvailableCondition {

  //  private static final String BROKER_RUNNING_BEAN = "brokerRunning";
  //
  //  private static final ConditionEvaluationResult ENABLED =
  //      ConditionEvaluationResult.enabled("@RabbitAvailable is not present");
  //
  //  private static final ThreadLocal<BrokerRunningSupport> BROKER_RUNNING_HOLDER =
  //      new ThreadLocal<>();
  //
  //  @Override
  ...
  //        MergedAnnotations.from(element.get(), MergedAnnotations.SearchStrategy.TYPE_HIERARCHY);
  ...
  //            brokerRunning =
  //                BrokerRunningSupport.isBrokerAndManagementRunningWithEmptyQueues(queues);
  //          } else {
  ...
  //    Store store = getStore(context);
  //    BrokerRunningSupport brokerRunning =
  //        store.remove(BROKER_RUNNING_BEAN, BrokerRunningSupport.class);
  //    if (brokerRunning != null) {
  ...
  //    BrokerRunningSupport brokerRunning =
  //        getParentStore(context).get(BROKER_RUNNING_BEAN, BrokerRunningSupport.class) == null
  //            ? getStore(context).get(BROKER_RUNNING_BEAN, BrokerRunningSupport.class)
  ...
  //    Class<?> type = parameterContext.getParameter().getType();
  //    return type.equals(ConnectionFactory.class)
