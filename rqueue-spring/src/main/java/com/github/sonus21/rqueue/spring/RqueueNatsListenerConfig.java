...
public class RqueueNatsListenerConfig {
  ...
  @Bean
  public NatsStreamValidator natsStreamValidator(NatsProvisioner natsProvisioner) {
    return new NatsStreamValidator(natsProvisioner, RqueueNatsConfig.defaults());
  }
}
