...
class RqueueConfigTest extends TestBase {
  ...
  private final RqueueConfig rqueueConfigVersion1 = new RqueueConfig(null, false, 1);
  private final RqueueConfig rqueueConfigVersion2 = new RqueueConfig(null, false, 2);
  private final RqueueConfig rqueueConfigVersion2ClusterMode = new RqueueConfig(null, false, 2);
